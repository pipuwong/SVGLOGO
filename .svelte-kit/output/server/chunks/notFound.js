import { c as building, o as onMount } from "./environment.js";
import "./exports.js";
import { p as set_current_component, r as run_all, q as current_component, t as identity, c as create_ssr_component, v as validate_component, u as getContext, a as add_attribute, o as onDestroy, w as get_store_value, x as createEventDispatcher, s as setContext, b as subscribe, h as compute_rest_props, i as spread, k as escape_object, j as escape_attribute_value, f as escape, g as each } from "./ssr.js";
import { r as readable, d as derived, w as writable, a as readonly } from "./index2.js";
import { i as inputStyles, b as buttonStyles, d as badgeStyles, A as ArrowUpRight } from "./arrow-up-right.js";
import { I as Icon, i as is_void } from "./Icon.js";
...
const Baseline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const iconNode = [
    ["path", { "d": "M4 20h16" }],
    ["path", { "d": "m6 16 6-12 6 12" }],
    ["path", { "d": "M8 12h8" }]
  ];
  return `${validate_component(Icon, "Icon").$$render($$result, Object.assign({}, { name: "baseline" }, $$props, { iconNode }), {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
  })}`;
});
const Baseline$1 = Baseline;
...
const Package_open = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const iconNode = [
    ["path", { "d": "M12 22v-9" }],
    [
      "path",
  ...
  return `${validate_component(Icon, "Icon").$$render($$result, Object.assign({}, { name: "package-open" }, $$props, { iconNode }), {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
  })}`;
});
const PackageOpen = Package_open;
...
function queryParam(name2, { encode = DEFAULT_ENCODER_DECODER.encode, decode = DEFAULT_ENCODER_DECODER.decode, defaultValue } = DEFAULT_ENCODER_DECODER, { debounceHistory = 0, pushHistory = true, sort = true, showDefaults = true, equalityFn } = {}) {
  const override = writable(null);
  let currentValue;
  const { subscribe: subscribe2 } = derived([page, override], ([$page, $override], set) => {
    if ($override != void 0) {
    ...
    const actualParam = $page?.url?.searchParams?.get?.(name2);
...
const Search = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { clearSearch } = $$props;
  let inputElement;
  if ($$props.searchTerm === void 0 && $$bindings.searchTerm && searchTerm !== void 0)
    $$bindings.searchTerm(searchTerm);
  if ($$props.placeholder === void 0 && $$bindings.placeholder && placeholder !== void 0)
    $$bindings.placeholder(placeholder);
  if ($$props.clearSearch === void 0 && $$bindings.clearSearch && clearSearch !== void 0)
    $$bindings.clearSearch(clearSearch);
  return `<div class="sticky top-[63px] z-50"><div class="relative w-full text-[16px]"><div class="absolute inset-y-0 left-0 flex items-center pl-3 text-neutral-500"><div class="pointer-events-none">${validate_component(SearchIcon, "SearchIcon").$$render(
    $$result,
    {
      size: 20,
      strokeWidth: searchTerm ? 2.5 : 1.5
    },
    {},
    {}
  )}</div></div> <input type="text"${add_attribute("placeholder", placeholder, 0)} autocomplete="off"${add_attribute("class", inputStyles, 0)}${add_attribute("value", searchTerm, 0)}${add_attribute("this", inputElement, 0)}> ${searchTerm.length > 0 ? `<div class="absolute inset-y-0 right-0 flex items-center pr-3"><button type="button" class="focus:outline-none focus:ring-1 focus:ring-neutral-300">${validate_component(X$1, "X").$$render($$result, { size: 18 }, {}, {})}</button></div>` : `<div class="absolute inset-y-0 right-0 flex items-center pr-4 text-neutral-500"><div class="flex h-full items-center pointer-events-none gap-x-1 font-mono">${validate_component(Command$1, "Command").$$render($$result, { size: 16 }, {}, {})} <span data-svelte-h="svelte-1c09r6x">K</span></div></div>`}</div></div>`;
});
function last(array) {
...
const Dialog_overlay = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Dialog_overlay$1, "DialogPrimitive.Overlay").$$render(
    ...
    Object.assign(
      ...
      { transitionConfig },
      {
        class: cn("fixed inset-0 z-50 bg-neutral-100/80 dark:bg-neutral-900/80 backdrop-blur-sm", className)
      },
      $$restProps
    ),
    {},
    ...
    default: () => {
      return `${validate_component(Dialog_overlay, "Dialog.Overlay").$$render($$result, {}, {}, {})} ${validate_component(Dialog_content$1, "DialogPrimitive.Content").$$render(
        ...
        Object.assign(
          ...
          { transitionConfig },
          {
            class: cn("fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] border border-neutral-200 dark:border-neutral-800 dark:bg-neutral-900 bg-white p-6 shadow-lg sm:rounded-lg md:w-full", className)
          },
          $$restProps
        ),
        {},
...
const Dialog_description = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Dialog_description$1, "DialogPrimitive.Description").$$render(
    ...
    Object.assign(
      {},
      {
        class: cn("text-sm opacity-70 mb-2", className)
      },
      $$restProps
    ),
    {},
...
let iconStroke$1 = 1.8;
let iconSize$1 = 16;
let mainDownloadStyles = "flex items-center space-x-2 rounded-md p-2 duration-100 hover:bg-neutral-200 dark:hover:bg-neutral-700/40";
let cardDownloadStyles = "flex w-full h-full flex-col p-4 rounded-md shadow-sm dark:bg-neutral-800/20 bg-neutral-200/10 border border-neutral-200 dark:border-neutral-800 space-y-2";
const DownloadSvg = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { svgInfo } = $$props;
  let { isDarkTheme } = $$props;
  if ($$props.svgInfo === void 0 && $$bindings.svgInfo && svgInfo !== void 0)
    $$bindings.svgInfo(svgInfo);
  if ($$props.isDarkTheme === void 0 && $$bindings.isDarkTheme && isDarkTheme !== void 0)
    $$bindings.isDarkTheme(isDarkTheme);
  return `${typeof svgInfo.route === "string" && svgInfo.wordmark === void 0 ? `<button title="Download Light & Dark variants"${add_attribute("class", mainDownloadStyles, 0)}>${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { size: iconSize$1, strokeWidth: iconStroke$1 }, {}, {})}</button>` : `${validate_component(Root$1, "Dialog").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(Trigger$1, "DialogTrigger").$$render(
        $$result,
        {
          title: "Download SVG",
        ...
        {
          default: () => {
            return `${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { size: iconSize$1, strokeWidth: iconStroke$1 }, {}, {})}`;
          }
        }
      )} ${validate_component(Dialog_content, "DialogContent").$$render($$result, { class: "max-w-[630px]" }, {}, {
        default: () => {
          return `${validate_component(Dialog_header, "DialogHeader").$$render($$result, {}, {}, {
            default: () => {
              return `${validate_component(Dialog_title, "DialogTitle").$$render($$result, {}, {}, {
                default: () => {
                  return `Download ${escape(svgInfo.title)}`;
                }
              })} ${validate_component(Dialog_description, "DialogDescription").$$render($$result, {}, {}, {
                default: () => {
                  return `This logo has multiple options to download.`;
                }
              })}`;
            }
          })} <div${add_attribute("class", cn("flex flex-col space-y-2 mt-4 h-full", "md:space-y-0 md:flex-row md:space-x-2 md:items-center md:justify-center"), 0)}>${typeof svgInfo.route === "string" ? `<div${add_attribute("class", cardDownloadStyles, 0)}><img${add_attribute("src", isDarkTheme() ? svgInfo.route : svgInfo.route, 0)}${add_attribute("alt", svgInfo.title, 0)} class="h-8 my-4"> <button title="Download logo"${add_attribute("class", buttonStyles, 0)}>${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { class: "mr-2", size: iconSize$1 }, {}, {})} <p data-svelte-h="svelte-11aelsk">Icon logo</p></button></div>` : `<div${add_attribute("class", cardDownloadStyles, 0)}><img${add_attribute("src", isDarkTheme() ? svgInfo.route.dark : svgInfo.route.light, 0)}${add_attribute("alt", svgInfo.title, 0)} class="h-10 my-4"> <button title="Logo with light & dark variants"${add_attribute("class", buttonStyles, 0)}>${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { size: iconSize$1 }, {}, {})} <p data-svelte-h="svelte-tplfo8">Light &amp; dark variants</p></button> <button title="Download light variant"${add_attribute("class", buttonStyles, 0)}>${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { class: "mr-2", size: iconSize$1 }, {}, {})}
              Only light variant</button> <button title="Download dark variant"${add_attribute("class", buttonStyles, 0)}>${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { class: "mr-2", size: iconSize$1 }, {}, {})}
              Only dark variant</button></div>`} ${typeof svgInfo.wordmark === "string" && svgInfo.wordmark !== void 0 ? `<div${add_attribute("class", cardDownloadStyles, 0)}><img${add_attribute("src", isDarkTheme() ? svgInfo.wordmark : svgInfo.wordmark, 0)}${add_attribute("alt", svgInfo.title, 0)} class="h-8 my-4"> <button title="Download Wordmark logo"${add_attribute("class", buttonStyles, 0)}>${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { class: "mr-2", size: iconSize$1 }, {}, {})} <p data-svelte-h="svelte-xe6gq4">Wordmark logo</p></button></div>` : ``} ${typeof svgInfo.wordmark !== "string" && svgInfo.wordmark !== void 0 ? `<div${add_attribute("class", cardDownloadStyles, 0)}><img${add_attribute(
            "src",
            isDarkTheme() ? svgInfo.wordmark.dark : svgInfo.wordmark.light,
            0
          )}${add_attribute("alt", svgInfo.title, 0)} class="h-10 my-4"> <button title="Download Wordmark light variant"${add_attribute("class", buttonStyles, 0)}>${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { class: "mr-2", size: iconSize$1 }, {}, {})}
              Light &amp; dark variants</button> <button title="Download Wordmark light variant"${add_attribute("class", buttonStyles, 0)}>${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { class: "mr-2", size: iconSize$1 }, {}, {})}
              Wordmark light variant</button> <button title="Download Wordmark dark variant"${add_attribute("class", buttonStyles, 0)}>${validate_component(DownloadIcon, "DownloadIcon").$$render($$result, { class: "mr-2", size: iconSize$1 }, {}, {})}
              Wordmark dark variant</button></div>` : ``}</div>`;
        }
      })}`;
    }
  })}`}`;
...
const Popover_content = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Popover_content$1, "PopoverPrimitive.Content").$$render(
    ...
    Object.assign({}, { transition }, { transitionConfig }, { align }, { sideOffset }, $$restProps, {
      class: cn("z-50 w-60 rounded-md border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4 text-popover-foreground shadow-md outline-none", className)
    }),
    {},
    {
      default: () => {
...
const CopySvg = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { iconSize: iconSize2 = 24 } = $$props;
  let { iconStroke: iconStroke2 = 2 } = $$props;
  let { isWordmarkSvg = false } = $$props;
  let { svgInfo } = $$props;
  let optionsOpen = false;
  if ($$props.iconSize === void 0 && $$bindings.iconSize && iconSize2 !== void 0)
    $$bindings.iconSize(iconSize2);
  if ($$props.iconStroke === void 0 && $$bindings.iconStroke && iconStroke2 !== void 0)
    $$bindings.iconStroke(iconStroke2);
  if ($$props.isWordmarkSvg === void 0 && $$bindings.isWordmarkSvg && isWordmarkSvg !== void 0)
    $$bindings.isWordmarkSvg(isWordmarkSvg);
  if ($$props.svgInfo === void 0 && $$bindings.svgInfo && svgInfo !== void 0)
    $$bindings.svgInfo(svgInfo);
  return `${validate_component(Root, "Popover.Root").$$render(
    $$result,
    {
      open: optionsOpen,
    ...
    {},
    {
      default: () => {
        return `${validate_component(Trigger, "Popover.Trigger").$$render(
          ...
          {
            default: () => {
              return `${optionsOpen ? `${validate_component(X$1, "X").$$render($$result, { size: iconSize2, strokeWidth: iconStroke2 }, {}, {})}` : `${`${validate_component(CopyIcon, "CopyIcon").$$render($$result, { size: iconSize2, strokeWidth: iconStroke2 }, {}, {})}`}`}`;
            }
          }
          ...
          {
            default: () => {
              return `<button${add_attribute("class", cn(buttonStyles, "rounded-md w-full"), 0)}${add_attribute(
                "title",
                isWordmarkSvg ? "Copy wordmark SVG to clipboard" : "Copy SVG to clipboard",
                0
              )}>${validate_component(ClipboardIcon, "ClipboardIcon").$$render($$result, { size: 16, strokeWidth: 2 }, {}, {})} <span data-svelte-h="svelte-715bit">Copy SVG</span></button> <button${add_attribute("class", cn(buttonStyles, "rounded-md w-full"), 0)} title="Copy PNG to clipboard" ${""}>${validate_component(ClipboardIcon, "ClipboardIcon").$$render($$result, { size: 16, strokeWidth: 2 }, {}, {})} <span data-svelte-h="svelte-fxvrds">Copy PNG</span></button>`;
            }
          }
        )}`;
      }
...
const SvgCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { svgInfo } = $$props;
  if ($$props.svgInfo === void 0 && $$bindings.svgInfo && svgInfo !== void 0)
    $$bindings.svgInfo(svgInfo);
  return `<div class="flex flex-col items-center justify-center rounded-md p-4 border border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100/80 dark:hover:bg-neutral-800/20 transition-colors duration-100 group"> ${`<img${add_attribute("class", cn("hidden dark:block", globalImageStyles), 0)}${add_attribute(
    "src",
    typeof svgInfo.route !== "string" ? svgInfo.route.dark : svgInfo.route,
    0
  )}${add_attribute("alt", svgInfo.title, 0)}${add_attribute("title", svgInfo.title, 0)} loading="lazy"> <img${add_attribute("class", cn("block dark:hidden", globalImageStyles), 0)}${add_attribute(
    "src",
    typeof svgInfo.route !== "string" ? svgInfo.route.light : svgInfo.route,
    0
  )}${add_attribute("alt", svgInfo.title, 0)}${add_attribute("title", svgInfo.title, 0)} loading="lazy">`}  <div class="mb-3 flex flex-col space-y-1 items-center justify-center"><p class="truncate text-[15px] font-medium text-balance text-center select-all">${escape(svgInfo.title)}</p> <div class="flex items-center space-x-1 justify-center">${Array.isArray(svgInfo.category) ? `${each(svgInfo.category.sort(), (c, index) => {
    return `<a${add_attribute("href", `/directory/${c.toLowerCase()}`, 0)}${add_attribute("class", badgeStyles, 0)}>${escape(c)} </a>`;
  })}` : `<a${add_attribute("href", `/directory/${svgInfo.category.toLowerCase()}`, 0)}${add_attribute("class", badgeStyles, 0)}>${escape(svgInfo.category)}</a>`}</div></div>  <div class="flex items-center space-x-1">${``} ${`${validate_component(CopySvg, "CopySvg").$$render(
    $$result,
    {
      iconSize,
      iconStroke,
    ...
    {},
    {}
  )}`} ${validate_component(DownloadSvg, "DownloadSvg").$$render(
    $$result,
    {
      svgInfo,
      isDarkTheme: () => {
    ...
    {},
    {}
  )}  ${svgInfo.wordmark !== void 0 ? `<button${add_attribute("title", "Show wordmark SVG", 0)} class="flex items-center space-x-2 rounded-md p-2 duration-100 hover:bg-neutral-200 dark:hover:bg-neutral-700/40">${`${validate_component(Baseline$1, "Baseline").$$render($$result, { size: iconSize, strokeWidth: iconStroke }, {}, {})}`}</button>` : ``}</div></div>`;
});
const Grid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6">${slots.default ? slots.default({}) : ``}</div>`;
});
const NotFound = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { notFoundTerm } = $$props;
  if ($$props.notFoundTerm === void 0 && $$bindings.notFoundTerm && notFoundTerm !== void 0)
    $$bindings.notFoundTerm(notFoundTerm);
  return `<div class="mt-6 flex w-full flex-col items-center justify-center text-gray-600 dark:text-gray-400">${validate_component(PackageOpen, "PackageOpen").$$render($$result, { size: 40, class: "mb-4" }, {}, {})} <p class="text-xl mb-1 font-medium" data-svelte-h="svelte-1oiggce">Couldn&#39;t find the Icon</p> <p class="text-md mb-4 font-mono">&quot;${escape(notFoundTerm)}&quot;</p> <div class="flex items-center space-x-1"><a href="https://github.com/pheralb/svgl?tab=readme-ov-file#-getting-started" target="_blank"${add_attribute("class", buttonStyles, 0)}><span data-svelte-h="svelte-62noer">Submit logo</span> ${validate_component(ArrowUpRight, "ArrowUpRight").$$render($$result, { size: 16 }, {}, {})}</a> <a href="https://github.com/pheralb/svgl/issues/new?assignees=pheralb&labels=request&projects=&template=request-svg-.md&title=%5BRequest%5D%3A" target="_blank"${add_attribute("class", buttonStyles, 0)}><span data-svelte-h="svelte-zcpwcg">Request Icon</span> ${validate_component(ArrowUpRight, "ArrowUpRight").$$render($$result, { size: 16 }, {}, {})}</a></div></div>`;
});
export {
  Grid as G,
  NotFound as N,
