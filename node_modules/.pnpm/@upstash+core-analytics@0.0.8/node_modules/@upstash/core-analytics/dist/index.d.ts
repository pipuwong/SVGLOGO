...
declare class Analytics {
    ...
    protected formatBucketAggregate(rawAggregate: [string, number][], groupBy: string, bucket: number): Aggregate;
    ...
    getMostAllowedBlocked(table: string, timestampCount: number, itemCount: number, timestamp?: number): Promise<{
        allowed: {
            identifier: string;
            count: number;
        }[];
