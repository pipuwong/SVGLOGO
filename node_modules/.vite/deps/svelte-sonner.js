...
// node_modules/.pnpm/svelte-sonner@0.3.22_svelte@4.2.15/node_modules/svelte-sonner/dist/internal/helpers.js
function cn(...classes) {
...
// node_modules/.pnpm/svelte-sonner@0.3.22_svelte@4.2.15/node_modules/svelte-sonner/dist/state.js
var toastsCounter = 0;
...
// node_modules/.pnpm/svelte-sonner@0.3.22_svelte@4.2.15/node_modules/svelte-sonner/dist/Toast.svelte
var file = "node_modules/.pnpm/svelte-sonner@0.3.22_svelte@4.2.15/node_modules/svelte-sonner/dist/Toast.svelte";
...
function create_if_block_14(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(line0, file, 297, 4, 9099);
      attr_dev(line1, "x1", "6");
      attr_dev(line1, "y1", "6");
      attr_dev(line1, "x2", "18");
      attr_dev(line1, "y2", "18");
      add_location(line1, file, 298, 4, 9142);
      ...
      add_location(svg, file, 286, 3, 8871);
      ...
      add_location(button, file, 274, 2, 8601);
    },
...
function create_else_block(ctx) {
  ...
  let if_block2 = (
    /*toast*/
    ctx[2].description && create_if_block_3(ctx)
  );
  let if_block3 = (
    /*toast*/
    ctx[2].cancel && create_if_block_2(ctx)
  );
  let if_block4 = (
    /*toast*/
    ctx[2].action && create_if_block_1(ctx)
  );
  const block = {
    c: function create() {
      if (if_block0)
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 328, 2, 9963);
    },
    m: function mount(target, anchor) {
      if (if_block0)
...
function create_if_block_7(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 311, 3, 9438);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      if (if_block0)
...
function create_if_block_5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 330, 4, 10010);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      if_blocks[current_block_type_index].m(div, null);
...
function create_if_block_3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 345, 4, 10325);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      if_blocks[current_block_type_index].m(div, null);
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(button, file, 366, 3, 10749);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, button, anchor);
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(button, file, 382, 3, 11082);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, button, anchor);
      append_hydration_dev(button, t);
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      ctx[17]}px`);
      add_location(li, file, 234, 0, 7481);
    },
    m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("toast" in $$new_props)
      $$invalidate(2, toast2 = $$new_props.toast);
    if ("index" in $$new_props)
      $$invalidate(3, index = $$new_props.index);
    if ("expanded" in $$new_props)
      $$invalidate(4, expanded = $$new_props.expanded);
    if ("invert" in $$new_props)
      $$invalidate(0, invert = $$new_props.invert);
    if ("position" in $$new_props)
      $$invalidate(35, position = $$new_props.position);
    if ("visibleToasts" in $$new_props)
      $$invalidate(36, visibleToasts = $$new_props.visibleToasts);
    if ("expandByDefault" in $$new_props)
      $$invalidate(5, expandByDefault = $$new_props.expandByDefault);
    if ("closeButton" in $$new_props)
      $$invalidate(6, closeButton = $$new_props.closeButton);
    if ("interacting" in $$new_props)
      $$invalidate(37, interacting = $$new_props.interacting);
    if ("cancelButtonStyle" in $$new_props)
      $$invalidate(7, cancelButtonStyle = $$new_props.cancelButtonStyle);
    if ("actionButtonStyle" in $$new_props)
      $$invalidate(8, actionButtonStyle = $$new_props.actionButtonStyle);
    if ("duration" in $$new_props)
      $$invalidate(38, duration = $$new_props.duration);
    if ("descriptionClass" in $$new_props)
      $$invalidate(9, descriptionClass = $$new_props.descriptionClass);
    if ("classes" in $$new_props)
      $$invalidate(1, classes = $$new_props.classes);
    if ("unstyled" in $$new_props)
      $$invalidate(10, unstyled = $$new_props.unstyled);
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("position" in $$props)
      $$invalidate(35, position = $$new_props.position);
    if ("visibleToasts" in $$props)
      $$invalidate(36, visibleToasts = $$new_props.visibleToasts);
    if ("expandByDefault" in $$props)
      $$invalidate(5, expandByDefault = $$new_props.expandByDefault);
    if ("closeButton" in $$props)
      $$invalidate(6, closeButton = $$new_props.closeButton);
    if ("interacting" in $$props)
      $$invalidate(37, interacting = $$new_props.interacting);
    if ("cancelButtonStyle" in $$props)
      $$invalidate(7, cancelButtonStyle = $$new_props.cancelButtonStyle);
    if ("actionButtonStyle" in $$props)
      $$invalidate(8, actionButtonStyle = $$new_props.actionButtonStyle);
    if ("duration" in $$props)
      $$invalidate(38, duration = $$new_props.duration);
    if ("descriptionClass" in $$props)
      $$invalidate(9, descriptionClass = $$new_props.descriptionClass);
    if ("classes" in $$props)
      $$invalidate(1, classes = $$new_props.classes);
    if ("unstyled" in $$props)
      $$invalidate(10, unstyled = $$new_props.unstyled);
    if ("mounted" in $$props)
      $$invalidate(12, mounted = $$new_props.mounted);
    if ("removed" in $$props)
      $$invalidate(13, removed = $$new_props.removed);
    if ("swiping" in $$props)
      $$invalidate(14, swiping = $$new_props.swiping);
    if ("swipeOut" in $$props)
      $$invalidate(15, swipeOut = $$new_props.swipeOut);
    if ("offsetBeforeRemove" in $$props)
      $$invalidate(16, offsetBeforeRemove = $$new_props.offsetBeforeRemove);
    if ("initialHeight" in $$props)
      $$invalidate(17, initialHeight = $$new_props.initialHeight);
    if ("toastRef" in $$props)
      $$invalidate(18, toastRef = $$new_props.toastRef);
    if ("offset" in $$props)
      $$invalidate(19, offset = $$new_props.offset);
    if ("closeTimerStartTimeRef" in $$props)
      closeTimerStartTimeRef = $$new_props.closeTimerStartTimeRef;
    if ("lastCloseTimerStartTimeRef" in $$props)
      lastCloseTimerStartTimeRef = $$new_props.lastCloseTimerStartTimeRef;
    if ("pointerStartRef" in $$props)
      pointerStartRef = $$new_props.pointerStartRef;
    if ("timeoutId" in $$props)
      $$invalidate(39, timeoutId = $$new_props.timeoutId);
    if ("remainingTime" in $$props)
      remainingTime = $$new_props.remainingTime;
    if ("effect" in $$props)
      $$subscribe_effect($$invalidate(20, effect = $$new_props.effect));
    if ("coords" in $$props)
      $$invalidate(21, coords = $$new_props.coords);
    if ("disabled" in $$props)
      $$invalidate(22, disabled = $$new_props.disabled);
    if ("isPromiseLoadingOrInfiniteDuration" in $$props)
      $$invalidate(40, isPromiseLoadingOrInfiniteDuration = $$new_props.isPromiseLoadingOrInfiniteDuration);
    if ("toastType" in $$props)
      $$invalidate(11, toastType = $$new_props.toastType);
    if ("toastDescription" in $$props)
      $$invalidate(41, toastDescription = $$new_props.toastDescription);
    if ("toastTitle" in $$props)
      $$invalidate(42, toastTitle = $$new_props.toastTitle);
    if ("toastsHeightBefore" in $$props)
      $$invalidate(43, toastsHeightBefore = $$new_props.toastsHeightBefore);
    if ("heightIndex" in $$props)
      $$invalidate(44, heightIndex = $$new_props.heightIndex);
    if ("toastDescriptionClass" in $$props)
      $$invalidate(23, toastDescriptionClass = $$new_props.toastDescriptionClass);
    if ("toastClass" in $$props)
      $$invalidate(24, toastClass = $$new_props.toastClass);
    if ("isVisible" in $$props)
      $$invalidate(25, isVisible = $$new_props.isVisible);
    if ("isFront" in $$props)
      $$invalidate(26, isFront = $$new_props.isFront);
  };
...
// node_modules/.pnpm/svelte-sonner@0.3.22_svelte@4.2.15/node_modules/svelte-sonner/dist/Loader.svelte
var file2 = "node_modules/.pnpm/svelte-sonner@0.3.22_svelte@4.2.15/node_modules/svelte-sonner/dist/Loader.svelte";
...
// node_modules/.pnpm/svelte-sonner@0.3.22_svelte@4.2.15/node_modules/svelte-sonner/dist/Icon.svelte
var file3 = "node_modules/.pnpm/svelte-sonner@0.3.22_svelte@4.2.15/node_modules/svelte-sonner/dist/Icon.svelte";
...
function create_if_block_32(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path0, file3, 53, 2, 1365);
      ...
      add_location(path1, file3, 56, 2, 1920);
      attr_dev(svg, "viewBox", "0 0 64 64");
      attr_dev(svg, "fill", "currentColor");
      attr_dev(svg, "height", "20");
      attr_dev(svg, "width", "20");
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      add_location(svg, file3, 46, 1, 1247);
    },
    m: function mount(target, anchor) {
...
function create_if_block_22(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path, file3, 39, 2, 912);
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr_dev(svg, "viewBox", "0 0 20 20");
      attr_dev(svg, "fill", "currentColor");
      attr_dev(svg, "height", "20");
      attr_dev(svg, "width", "20");
      add_location(svg, file3, 32, 1, 794);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, svg, anchor);
...
function create_if_block_15(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(path, "clip-rule", "evenodd");
      add_location(path, file3, 25, 2, 562);
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr_dev(svg, "viewBox", "0 0 20 20");
      attr_dev(svg, "fill", "currentColor");
      attr_dev(svg, "height", "20");
      attr_dev(svg, "width", "20");
      add_location(svg, file3, 18, 1, 444);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, svg, anchor);
      append_hydration_dev(svg, path);
...
function create_if_block2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(path, "clip-rule", "evenodd");
      add_location(path, file3, 11, 2, 192);
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr_dev(svg, "viewBox", "0 0 20 20");
      attr_dev(svg, "fill", "currentColor");
      attr_dev(svg, "height", "20");
      attr_dev(svg, "width", "20");
      add_location(svg, file3, 4, 1, 74);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, svg, anchor);
      append_hydration_dev(svg, path);
...
var Icon = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance3, create_fragment3, safe_not_equal, { type: 0 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "Icon",
      options,
...
function create_if_block3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(section, "aria-label", section_aria_label_value = `Notifications ${/*hotkeyLabel*/
      ctx[15]}`);
      attr_dev(section, "tabindex", section_tabindex_value = -1);
      add_location(section, file4, 138, 1, 4184);
    },
    m: function mount(target, anchor) {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (!current || dirty[0] & /*hotkeyLabel*/
      32768 && section_aria_label_value !== (section_aria_label_value = `Notifications ${/*hotkeyLabel*/
      ctx2[15]}`)) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(138:0) {#if $toasts.length > 0}",
    ctx
  });
  return block;
}
function fallback_block_4(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      66560)
        loader_changes.visible = /*toast*/
        ctx2[40].type === "loading";
...
function create_loading_icon_slot(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      if (loading_icon_slot_or_fallback)
        loading_icon_slot_or_fallback.l(nodes);
    },
    m: function mount(target, anchor) {
      if (loading_icon_slot_or_fallback) {
  ...
  const block = {
    c: function create() {
      if (success_icon_slot_or_fallback)
        success_icon_slot_or_fallback.c();
    },
    l: function claim(nodes) {
      if (success_icon_slot_or_fallback)
        success_icon_slot_or_fallback.l(nodes);
    },
    m: function mount(target, anchor) {
      if (success_icon_slot_or_fallback) {
    ...
    d: function destroy(detaching) {
      if (success_icon_slot_or_fallback)
        success_icon_slot_or_fallback.d(detaching);
    }
  };
  dispatch_dev("SvelteRegisterBlock", {
    block,
  ...
  const block = {
    c: function create() {
      if (error_icon_slot_or_fallback)
        error_icon_slot_or_fallback.c();
    },
    l: function claim(nodes) {
      if (error_icon_slot_or_fallback)
        error_icon_slot_or_fallback.l(nodes);
    },
    m: function mount(target, anchor) {
      if (error_icon_slot_or_fallback) {
    ...
    d: function destroy(detaching) {
      if (error_icon_slot_or_fallback)
        error_icon_slot_or_fallback.d(detaching);
    }
  };
  dispatch_dev("SvelteRegisterBlock", {
    block,
  ...
  const block = {
    c: function create() {
      if (warning_icon_slot_or_fallback)
        warning_icon_slot_or_fallback.c();
    },
    l: function claim(nodes) {
      if (warning_icon_slot_or_fallback)
        warning_icon_slot_or_fallback.l(nodes);
    },
    m: function mount(target, anchor) {
      if (warning_icon_slot_or_fallback) {
    ...
    d: function destroy(detaching) {
      if (warning_icon_slot_or_fallback)
        warning_icon_slot_or_fallback.d(detaching);
    }
  };
  dispatch_dev("SvelteRegisterBlock", {
    block,
  ...
  const block = {
    c: function create() {
      if (info_icon_slot_or_fallback)
        info_icon_slot_or_fallback.c();
    },
    l: function claim(nodes) {
      if (info_icon_slot_or_fallback)
        info_icon_slot_or_fallback.l(nodes);
    },
    m: function mount(target, anchor) {
      if (info_icon_slot_or_fallback) {
    ...
    d: function destroy(detaching) {
      if (info_icon_slot_or_fallback)
        info_icon_slot_or_fallback.d(detaching);
    }
  };
  dispatch_dev("SvelteRegisterBlock", {
    block,
...
function create_each_block_1(key_1, ctx) {
  ...
  toast_1 = new Toast_default({
    props: {
      ...
      actionButtonStyle: (
        /*toastOptions*/
        ((_a = ctx[6]) == null ? void 0 : _a.actionButtonStyle) || ""
      ),
      cancelButtonStyle: (
        /*toastOptions*/
        ((_b = ctx[6]) == null ? void 0 : _b.cancelButtonStyle) || ""
      ),
      class: (
        /*toastOptions*/
        ((_c = ctx[6]) == null ? void 0 : _c.class) || ""
      ),
      descriptionClass: (
        /*toastOptions*/
        ((_d = ctx[6]) == null ? void 0 : _d.descriptionClass) || ""
      ),
      classes: (
        /*toastOptions*/
        ctx[6].classes || {}
      ...
      duration: (
        /*toastOptions*/
        ((_e = ctx[6]) == null ? void 0 : _e.duration) ?? /*duration*/
        ctx[3]
      ),
      unstyled: (
        /*toastOptions*/
        ctx[6].unstyled || false
      ),
      $$slots: {
  ...
  const block = {
    ...
    p: function update(new_ctx, dirty) {
      ...
      if (dirty[0] & /*invert*/
      1)
        toast_1_changes.invert = /*invert*/
        ctx[0];
      if (dirty[0] & /*visibleToasts*/
      16)
        toast_1_changes.visibleToasts = /*visibleToasts*/
        ctx[4];
      if (dirty[0] & /*closeButton*/
      32)
        toast_1_changes.closeButton = /*closeButton*/
        ctx[5];
      if (dirty[0] & /*interacting*/
      4096)
        toast_1_changes.interacting = /*interacting*/
        ctx[12];
      if (dirty[0] & /*possiblePositions*/
      65536)
        toast_1_changes.position = /*position*/
        ctx[9];
      if (dirty[0] & /*expand*/
      4)
        toast_1_changes.expandByDefault = /*expand*/
        ctx[2];
      if (dirty[0] & /*expanded*/
      2048)
        toast_1_changes.expanded = /*expanded*/
        ctx[11];
      if (dirty[0] & /*toastOptions*/
      64)
        toast_1_changes.actionButtonStyle = /*toastOptions*/
        ((_a2 = ctx[6]) == null ? void 0 : _a2.actionButtonStyle) || "";
      if (dirty[0] & /*toastOptions*/
      64)
        toast_1_changes.cancelButtonStyle = /*toastOptions*/
        ((_b2 = ctx[6]) == null ? void 0 : _b2.cancelButtonStyle) || "";
      if (dirty[0] & /*toastOptions*/
      64)
        toast_1_changes.class = /*toastOptions*/
        ((_c2 = ctx[6]) == null ? void 0 : _c2.class) || "";
      if (dirty[0] & /*toastOptions*/
      64)
        toast_1_changes.descriptionClass = /*toastOptions*/
        ((_d2 = ctx[6]) == null ? void 0 : _d2.descriptionClass) || "";
      if (dirty[0] & /*toastOptions*/
      64)
        toast_1_changes.classes = /*toastOptions*/
        ctx[6].classes || {};
      if (dirty[0] & /*toastOptions, duration*/
      72)
        toast_1_changes.duration = /*toastOptions*/
        ((_e2 = ctx[6]) == null ? void 0 : _e2.duration) ?? /*duration*/
        ctx[3];
      if (dirty[0] & /*toastOptions*/
      64)
        toast_1_changes.unstyled = /*toastOptions*/
        ctx[6].unstyled || false;
      if (dirty[0] & /*$toasts, possiblePositions*/
      66560 | dirty[1] & /*$$scope*/
      8) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(171:4) {#each $toasts.filter((toast) => (!toast.position && index === 0) || toast.position === position) as toast, index (toast.id)}",
    ctx
  });
  return block;
}
function create_each_block2(ctx) {
  ...
  let ol_levels = [
    ...
    },
    {
      ...
      ctx[8] === "auto" ? getDocumentDirection() : (
        /*dir*/
        ctx[8]
      )
    },
  ...
  const block = {
    ...
    p: function update(new_ctx, dirty) {
      ...
      set_attributes(ol, ol_data = get_spread_update(ol_levels, [
        ...
        4194304 && ol_class_value !== (ol_class_value = /*$$props*/
        ctx[22].class)) && { class: ol_class_value },
        { "data-sonner-toaster": "" },
        ...
        (!current || dirty[0] & /*dir*/
        256 && ol_dir_value !== (ol_dir_value = /*dir*/
        ctx[8] === "auto" ? getDocumentDirection() : (
          /*dir*/
          ctx[8]
        ))) && { dir: ol_dir_value },
        (!current || dirty[0] & /*possiblePositions*/
        65536 && ol_data_y_position_value !== (ol_data_y_position_value = /*position*/
        ctx[9].split("-")[0])) && {
          "data-y-position": ol_data_y_position_value
        },
        (!current || dirty[0] & /*possiblePositions*/
        65536 && ol_data_x_position_value !== (ol_data_x_position_value = /*position*/
        ctx[9].split("-")[1])) && {
          "data-x-position": ol_data_x_position_value
        },
        (!current || dirty[0] & /*$$props*/
        4194304 && ol_style_value !== (ol_style_value = /*$$props*/
        ctx[22].style)) && { style: ol_style_value },
        dirty[0] & /*$$restProps*/
        8388608 && /*$$restProps*/
        ctx[23]
      ]));
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(140:2) {#each possiblePositions as position, index}",
    ctx
  });
  return block;
}
function create_fragment4(ctx) {
  ...
  let if_block = (
    /*$toasts*/
    ctx[10].length > 0 && create_if_block3(ctx)
  );
  const block = {
    c: function create() {
      if (if_block)
...
function instance4($$self, $$props, $$invalidate) {
  ...
  validate_store(toasts, "toasts");
  component_subscribe($$self, toasts, (value) => $$invalidate(10, $toasts = value));
  validate_store(heights, "heights");
  component_subscribe($$self, heights, (value) => $$invalidate(17, $heights = value));
  let expanded = false;
  ...
  function ol_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      listRef = $$value;
      $$invalidate(14, listRef);
    });
  }
  const mouseenter_handler = () => $$invalidate(11, expanded = true);
  const mousemove_handler = () => $$invalidate(11, expanded = true);
  const mouseleave_handler = () => {
    if (!interacting) {
      $$invalidate(11, expanded = false);
    }
  };
  const pointerdown_handler = () => $$invalidate(12, interacting = true);
  const pointerup_handler = () => $$invalidate(12, interacting = false);
  $$self.$$set = ($$new_props) => {
    ...
    if ("theme" in $$new_props)
      $$invalidate(24, theme = $$new_props.theme);
    if ("position" in $$new_props)
      $$invalidate(9, position = $$new_props.position);
    if ("hotkey" in $$new_props)
      $$invalidate(25, hotkey = $$new_props.hotkey);
    if ("richColors" in $$new_props)
      $$invalidate(1, richColors = $$new_props.richColors);
    if ("expand" in $$new_props)
      $$invalidate(2, expand = $$new_props.expand);
    if ("duration" in $$new_props)
      $$invalidate(3, duration = $$new_props.duration);
    if ("visibleToasts" in $$new_props)
      $$invalidate(4, visibleToasts = $$new_props.visibleToasts);
    if ("closeButton" in $$new_props)
      $$invalidate(5, closeButton = $$new_props.closeButton);
    if ("toastOptions" in $$new_props)
      $$invalidate(6, toastOptions = $$new_props.toastOptions);
    if ("offset" in $$new_props)
      $$invalidate(7, offset = $$new_props.offset);
    if ("dir" in $$new_props)
      $$invalidate(8, dir = $$new_props.dir);
    if ("$$scope" in $$new_props)
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("dir" in $$props)
      $$invalidate(8, dir = $$new_props.dir);
    if ("expanded" in $$props)
      $$invalidate(11, expanded = $$new_props.expanded);
    if ("interacting" in $$props)
      $$invalidate(12, interacting = $$new_props.interacting);
    if ("actualTheme" in $$props)
      $$invalidate(13, actualTheme = $$new_props.actualTheme);
    if ("listRef" in $$props)
      $$invalidate(14, listRef = $$new_props.listRef);
    if ("lastFocusedElementRef" in $$props)
      lastFocusedElementRef = $$new_props.lastFocusedElementRef;
    if ("isFocusWithinRef" in $$props)
      isFocusWithinRef = $$new_props.isFocusWithinRef;
    if ("hotkeyLabel" in $$props)
      $$invalidate(15, hotkeyLabel = $$new_props.hotkeyLabel);
    if ("possiblePositions" in $$props)
      $$invalidate(16, possiblePositions = $$new_props.possiblePositions);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
  $$self.$$.update = () => {
    ...
    1536) {
      $:
        $$invalidate(16, possiblePositions = Array.from(new Set([
          position,
    ...
    33554432) {
      $:
        $$invalidate(15, hotkeyLabel = hotkey.join("+").replace(/Key/g, "").replace(/Digit/g, ""));
    }
    ...
    16777216) {
      $: {
        if (theme !== "system") {
          $$invalidate(13, actualTheme = theme);
        }
        if (typeof window !== "undefined") {
          if (theme === "system") {
            if (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches) {
              $$invalidate(13, actualTheme = "dark");
            } else {
              $$invalidate(13, actualTheme = "light");
            }
          }
          window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", ({ matches }) => {
            $$invalidate(13, actualTheme = matches ? "dark" : "light");
          });
        }
      }
    }
